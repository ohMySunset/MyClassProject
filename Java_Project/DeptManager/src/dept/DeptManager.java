...
public class DeptManager {
	...
	// 부서입력 메소드 : 사용자에게 입력받은 데이터를 DAO를 이용해서 DB에 입력	
	void insertDept() {
		...
		System.out.println("부서지역을 입력해주세요.");
		...
		Connection conn = null;
		 ...
		 if(resultCnt>0) {
			 ...
			 System.out.println("데이터가 입력에 실패하였습니다.");
		 }
		
	}
	
	// 부서 정보를 수정하는 메소드 : 사용자에게 입력받은 데이터를 DAO를 이용해서 수정
	void editDept() {
		
		System.out.println("수정을 원하시는 부서 번호를 입력해주세요.");
		String deptno = sc.nextLine();
		...
		Connection conn = null;
		 ...
		 if(resultCnt>0) {
			 ...
			 System.out.println("데이터가 수정에 실패하였습니다.");
		 }
	...
	void delDept() {
		...
		System.out.println("삭제를 원하시는 부서 번호를 입력해주세요.");
		String deptno = sc.nextLine();

...
public class PhoneBookManager {
    ...
    PhoneBookManager(int num){
    	pBook = new PhoneBasicInfor[num];  //생성자의 매개변수의 인자를 전달받아 배열 생성
    	cnt = 0;  	
    }
   ...
   private void addInfor(PhoneInfor info) {
    ...
    public void insertInfo() {
    	...
    	System.out.println(PhoneInfor.INSERT_BASIC +". 기본");
    	System.out.println(PhoneInfor.INSERT_UNIV +". 대학");
    	System.out.println(PhoneInfor.INSERT_COMPANY +". 회사");
    	System.out.println(PhoneInfor.INSERT_CAFE +". 동호회");
    	...
    	switch (select) {
    	case PhoneInfor.INSERT_BASIC : //인스턴스 생성 -> 배열에 저장
    		addInfor(PhoneInfor.showInfor());
    		break;
    	case PhoneInfor.INSERT_UNIV : // 추가정보를 받고 -> 인스턴스 생성 -> 배열에 저장
    		//전공, 학년 

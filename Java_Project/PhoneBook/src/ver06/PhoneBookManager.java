...
public class PhoneBookManager {
	...
	// 생성자 : Singleton 싱클톤 처리 -> 외부에서 인스턴스를 생성하지 못하도록 함.
    ...
    //클래스 내부에서 인스턴스 생성 
    //외부 참조를 막기 위해 private 클래스 내에서 미리 생성되어 있어야 하므로 static !!!
